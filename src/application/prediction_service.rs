...
use crate::{
    domain::models::prediction::{
        DetectionResponse, OsteoporosisResponse, PredictionResponse, TBResponse,
    },
...
impl PredictionService {
    ...
    pub async fn predict_image(&self, image_data: Vec<u8>) -> Result<HttpResponse, AppError> {
        ...
        let response = self
            .client
            .post(format!("{}/predict", self.ml_api_url))
            .multipart(form)
            .send()
            .await
            .map_err(|e| {
    ...
    pub async fn detect_breast_cancer(
        ...
        let response = self
            .client
            .post(format!("{}/detect", self.ml_api_url))
            .multipart(form)
            .send()
            .await
            .map_err(|e| {
    ...
    pub async fn predict_tuberculosis(
        ...
        let response = self
            .client
            .post(format!("{}/predict_tb", self.ml_api_url))
            .multipart(form)
            .send()
            .await
            .map_err(|e| {
    ...
    pub async fn predict_osteoporosis(
        ...
        let response = self
            .client
            .post(format!("{}/osteoporosis", self.ml_api_url))
            .multipart(form)
            .send()
            .await
            .map_err(|e| {
        ...
        let osteoporosis_response: OsteoporosisResponse = serde_json::from_value(json_value)
            .map_err(|e| {
