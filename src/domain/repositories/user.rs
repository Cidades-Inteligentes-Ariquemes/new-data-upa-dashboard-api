use crate::domain::models::user::{
    AddApplicationDto, AddHealthUnitDto, AddVerificationCodeDto, AddVerificationCodeResponse,
    CreateFeedbackOsteoporosisDto, CreateFeedbackRespiratoryDiseasesDto,
    CreateFeedbackTuberculosisDto, CreateUserDto, FeedbackOsteoporosisResponse,
...
pub trait UserRepository: Send + Sync + 'static {
    ...
    async fn update_enabled(
        &self,
        id: Uuid,
        new_enabled: UpdateEnabledUserDto,
    ...
    async fn verify_code_exist(&self, id: Uuid)
        -> Result<AddVerificationCodeResponse, sqlx::Error>;
